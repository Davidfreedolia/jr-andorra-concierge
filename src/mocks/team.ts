...
export const TEAM: TeamMember[] = [
  ...
  },
  {
    ...
    initials: "DC",
    role: {
      ca: "Producte i tecnologia",
      es: "Producto y tecnología",
      fr: "Produit et technologie",
      en: "Product and technology",
      de: "Produkt und Technologie",
    },
    line: {
      ca: "FREEDOLIA. La web, l'espai del client i el sistema d'operacions amb què treballa l'equip.",
      es: "FREEDOLIA. La web, el espacio del cliente y el sistema de operaciones con el que trabaja el equipo.",
      fr: "FREEDOLIA. Le site, l'espace client et le système d'exploitation avec lequel l'équipe travaille.",
      en: "FREEDOLIA. The website, the client area and the operations system the team works with.",
