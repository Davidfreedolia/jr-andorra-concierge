...
export type AreaIconName = AreaNavKey | "exit";

const PATHS: Record<AreaIconName, string> = {
...
export function AreaIcon({ name, className = "" }: { name: AreaIconName; className?: string }) {
  return (
    <svg
      viewBox="0 0 24 24"
      width="22"
